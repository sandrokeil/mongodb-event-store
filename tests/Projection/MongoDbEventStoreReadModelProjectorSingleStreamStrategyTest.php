 ...
 * @group SingleStream
 */
class MongoDbEventStoreReadModelProjectorSingleStreamStrategyTest extends AbstractMongoDbEventStoreReadModelProjectorTest
{
    protected function getPersistenceStrategy(): PersistenceStrategy
    {
        return new PersistenceStrategy\MongoDbSingleStreamStrategy();
    }
}
